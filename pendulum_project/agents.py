...
class ObserverAgent(Agent):
    ...
    def __init__(
        ...
        super().__init__(environment, allow_gpu, output_shape)
    ...
    def select_action(self,
        ...
        if self.method == 'first_spike':
            ...
            if spikes.shape[0] == 0:
                ...
                return (self.environment.action_space.sample() - 4) / 2
            else:
                return [(spikes[0, 1] - 4) / 2]
...
class PendulumObserverAgent(ObserverAgent):
    """
    A agent in Gym Pendulum-v1 environment.
    Parameters
    ----------
    environment : GymEnvironment
        The environment of the observer agent.
    ...
    def __init__(
        ...
        super().__init__(environment, method, dt, learning, reward_fn, allow_gpu, output_shape)
    ...
    def build_network(self) -> None:
        ...
        """
        # Input layer
        s2 = Input(shape=[2, 3], traces=True,
