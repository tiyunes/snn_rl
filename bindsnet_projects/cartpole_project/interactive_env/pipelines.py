...
#             print("\nEnv_step: self.action_function: ", self.action_function)
            self.action = self.action_function(episode=self.episode,
                                               num_episodes=self.num_episodes,
                                               **kwargs)

        # Run a step of the environment.
        # if not isinstance(self.action, int): # for pendulum not working
...
#         print("obs: ", obs) 
#         print("inputs: ", inputs)
#         print("inputs shape: ", inputs['S2'].shape)
...
#             print("\nBefore step: self.action_function: ", self.action_function)

            self.network.reset_state_variables()
#             print("Before_step")
            self.step((obs, reward, done, info), **kwargs)
#             print("\nAfter step: self.action_function: ", self.action_function)
