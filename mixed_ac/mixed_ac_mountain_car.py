...
class PlaceCell:
    def __init__(self, rho_rc=300, 
                  sigma1=0.1, sigma2=7.79e-3,
                  dt=2e-3, n_neurons=361, **kwargs):
        self.rho_rc = rho_rc
        self.sigma1 = sigma1
        self.sigma2 = sigma2
        ...
        self.m_values = np.arange(-9, 10)
        self.n_values = np.arange(-9, 10)
